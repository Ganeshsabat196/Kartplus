...
export class Api extends PureComponent {
  ...
  constructor() {
    ...
    this.state = {
      articles: this.articles.slice(0, 9),
    }
  ...
  loadmore = () => {
    a = a + 10;
    this.setState({
      articles: sortedItems.slice(0, a)
    })
  }
 
  HomeDecoration = () => {
   
    sortedItems = this.articles.filter((elem) => {
        return elem.category === 'home-decoration'
      })

    this.setState({
      articles: sortedItems.slice(0, 10)
    })
  ...
  filterData=(event)=>{
    ...
    sortedItems=this.articles.filter((elem)=>{
      return  elem.title.toLowerCase().includes(filteredData.toLowerCase())|| elem.category.toLowerCase().includes(filteredData.toLowerCase());
    })
    this.setState({
      articles: sortedItems.slice(0, 10)
    })
  ...
  render() {
    ...
    return (
      <>
        <div className="input-group search container mt-5">
          {/* <div className="dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a className="dropdown-item" >Mens</a>
              <a className="dropdown-item" >Womens</a>
              <a className="dropdown-item" >Childs</a>
            </div>
          </div> */}
          <input type="search" className="form-control rounded mb-3 " placeholder="Search" aria-label="Search" aria-describedby="search-addon" onChange={this.filterData} id="sortkey " />
          <button className="btn btn-outline-primary" style={{height:"10%"}}>Search</button>
        </div>


        <div className="container-fluid text-center">
        <button className="btn btn-primary m-3" onClick={this.HomeDecoration}>Decoration</button>
        <button className="btn btn-primary m-3" onClick={this.smartphones}>SmartPhones</button>
        <button className="btn btn-primary m-3" onClick={this.laptops}>Laptops</button>
        <button className="btn btn-primary m-3" onClick={this.fragrances}>Fragrances</button>
        <button className="btn btn-primary m-3" onClick={this.skincare}>Skincare</button>
        </div>
        <div className="container-fluid mt-3">
          <div className="row m-auto">
            {
              sortedItems==0 && <div class="alert alert-danger" role="alert">
              <h4 class="alert-heading">Search Not Found</h4>
              <p>Search the item more specifically</p>
            </div>
            }
            {sortedItems!=0 &&
              this.state.articles.map((elem) => {
                return <div className="card col-md-4 mt-3 mb-3 " style={{ width: "24rem" }}>
                  <img className="card-img-top " src={elem.images[0]} alt="Cardimagecap" />
        ...
        <div className="load">
        <button type="button" className="btn btn-light" id='load' onClick={this.loadmore}><strong><i> Load more</i></strong> </button>
        </div>
