...
export class Decoration extends PureComponent {
    articles = [{
        "id": 1,
        "title": "iPhone 9",
        "description": "An apple mobile which is nothing like apple",
    ...
    constructor() {
        ...
        this.state = {
            articles: sortedItems.slice(0, 9),
        }
            ...
            <>
                <>
                    <div className="input-group search container mt-5">
                        <input type="search" className="form-control rounded mb-3 " placeholder="Search" aria-label="Search" aria-describedby="search-addon" id="sortkey " />
                        <button className="btn btn-outline-primary" style={{ height: "10%" }}>Search</button>
                    </div>


                    {/* <div className="container-fluid sortbtn">
                        <button className="btn btn-primary m-3" onClick={this.HomeDecoration}>Decoration</button>
                        <button className="btn btn-primary m-3" onClick={this.smartphones}>Mobiles</button>
